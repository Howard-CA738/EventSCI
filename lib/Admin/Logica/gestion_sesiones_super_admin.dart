      ...
      void _onFilialChanged(String? filial) {
        setState(() {
          ...
          if (filial != null && _estructura.containsKey(filial)) {
            final facultades =
    (_estructura[filial] as Map<String, dynamic>?)?['facultades'] as Map<String, dynamic>?;
      ...
      void _onFacultadChanged(String? facultad) {
        setState(() {
          ...
          if (_selectedFilial != null &&
            ...
            final facultades =
    (_estructura[_selectedFilial!] as Map<String, dynamic>?)?['facultades'] as Map<String, dynamic>?;
if (facultades != null && facultades.containsKey(facultad)) {
  _carrerasDisponibles = List<Map<String, dynamic>>.from(
      ...
      Future<void> _loadEstudiantes() async {
        ...
        try {
          final filialNombre =
    ((_estructura[_selectedFilial] as Map<String, dynamic>?)?['nombre'] as String?) ?? '';
          ...
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color:
                        selected ? Colors.white : Colors.white.withAlpha(76)),
              ),
              child: Text(
                label,
                style: TextStyle(
                ...
                children: [
                  if (_modoSeleccion) ...[
                    Icon(
                      ...
                      color:
                          seleccionado ? _accentColor : Colors.grey[400],
                      size: 26,
                    ),
                    const SizedBox(width: 12),
                  ],
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(20),
                          border:
                              Border.all(color: estadoColor.withAlpha(76)),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
