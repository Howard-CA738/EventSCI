  ...
  class _GestionJuradosSuperAdminScreenState
    ...
    final JuradosService _juradosService = JuradosService();
...
if (facultades != null && facultades.containsKey(facultad)) {
  _carrerasDisponibles = List<Map<String, dynamic>>.from(
    ...
    Future<void> _cargarJurados() async {
      ...
      try {
        final list = await _juradosService.obtenerJurados(
          filialId: _filialId!,
          facultad: _facultad!,
    ...
    Future<List<String>> _cargarCategoriasPorEvento(String eventoId) async {
      try {
        return await _juradosService.obtenerCategoriasPorEvento(eventoId);
      } catch (e) {
    ...
    Future<List<Map<String, dynamic>>> _cargarEventos() async {
      ...
      try {
        return await _juradosService.obtenerEventos(
          filialId: _filialId,
          facultad: _facultad,
    ...
    Future<String> _crearJurado({
      ...
      return _juradosService.crearJurado(
        nombre: nombre,
        usuario: usuario,
        password: password,
    ...
    Future<bool> _actualizarJurado({
      ...
      return _juradosService.actualizarJurado(
        id: id,
        nombre: nombre,
        usuario: usuario,
        password: password,
    ...
    Future<void> _eliminarJurado(String id, String nombre) async {
      ...
      if (confirmar == true) {
        await _juradosService.eliminarJurado(id);
