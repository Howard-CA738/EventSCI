...
import '../logica/notas_por_sellos_service.dart';
...
class _NotasPorSellosScreenState extends State<NotasPorSellosScreen>
  ...
  final NotasPorSellosService _service = NotasPorSellosService();
  ...
  Future<void> _cargarNotasDeEvento(String eventoId) async {
    ...
    try {
      final resultado = await _service.cargarNotasDeEvento(
        filialId: _filialId,
        facultad: _facultad,
        carreraId: _carreraId,
      ...
      setState(() {
        _tieneConfig = resultado.tieneConfig;
        _metaSellos = resultado.metaSellos;
        _notasEstudiantes = resultado.notas;
        _ordenDesc = true;
      });
