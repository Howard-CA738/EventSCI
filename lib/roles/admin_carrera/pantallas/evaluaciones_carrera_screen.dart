...
import 'detalle_evaluaciones_carrera_screen.dart';
import '../logica/evaluaciones_carrera_service.dart';
...
class _EvaluacionesCarreraScreenState
  ...
  final _service = EvaluacionesCarreraService();
  ...
  Future<void> _abrirEvento(Map<String, dynamic> evento) async {
    ...
    try {
      final evaluaciones =
          await _service.cargarEvaluacionesDeEvento(eventoId);
      if (mounted) {
