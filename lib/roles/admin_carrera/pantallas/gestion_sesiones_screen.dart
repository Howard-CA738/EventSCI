...
import '../datos/estado_sesion.dart';
...
class _GestionSesionesScreenState extends State<GestionSesionesScreen> {
  final GestionSesionesService _service = GestionSesionesService();
  ...
  Widget build(BuildContext context) {
    final totalSinSesion = _estudiantes
        .where((e) => calcularEstadoSesion(e) == EstadoSesion.sinSesion)
        .length;
    final totalBloqueados = _estudiantes
        .where((e) => calcularEstadoSesion(e) == EstadoSesion.bloqueado)
        .length;
    final totalReseteados = _estudiantes
        .where((e) => calcularEstadoSesion(e) == EstadoSesion.reseteado)
        .length;
  ...
  Widget _buildEstudianteCard(Map<String, dynamic> e, int index) {
    final estado = calcularEstadoSesion(e);
    ...
    switch (estado) {
      case EstadoSesion.sinSesion:
        ...
        break;
      case EstadoSesion.bloqueado:
        estadoColor = Colors.red;
        estadoLabel = 'Bloqueado';
        estadoIcon = Icons.lock_rounded;
        break;
      case EstadoSesion.reseteado:
                  ...
                  if (!_modoSeleccion) ...[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (estado != EstadoSesion.bloqueado) ...[
